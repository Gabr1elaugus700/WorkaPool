...
_Avoid_: Order (Order Loss aggregate), Ordem de Serviço, Carga
...
_Avoid_: Situação da Carga, sitcar, status do Acompanhamento
...
**Pedido perdido**:
In Order Loss speech: a Pedido whose negotiation was lost (also: venda perdida, negociação perdida). See Order Loss context.
