...
-- CreateIndex
CREATE INDEX "orders_codRep_idx" ON "orders"("codRep");
...
-- AddForeignKey
ALTER TABLE "orders" ADD CONSTRAINT "orders_codRep_fkey" FOREIGN KEY ("codRep") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
