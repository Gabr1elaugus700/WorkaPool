...
| [.cursor/skills/](./.cursor/skills/) | [tlc-spec-driven](./.cursor/skills/tlc-spec-driven/SKILL.md), [impeccable](./.cursor/skills/impeccable/SKILL.md), [create-github-issue](./.cursor/skills/create-github-issue/SKILL.md), [wt](./.cursor/skills/wt/SKILL.md) (`/wt <issue>` cria a worktree pelo script) |
